...
public class umkPredmetDocument extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        String idPredmet = request.getParameter("IDUmkPredmet");

        List<TUmkPredmetDocument> TUmkPredmetDocumentList = TUmkPredmetDocumentFacade.findAllByIDPredmet(idPredmet);
        getServletContext().setAttribute("TUmkPredmetDocument", TUmkPredmetDocumentList);
